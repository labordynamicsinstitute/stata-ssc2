...
{pstd}
Daily snapshots exist from {bf:2021-12-23} onward; three earlier snapshots
...
{phang}
{opt from(url)} specifies the base URL of the snapshot mirror; the default
    is {cmd:https://raw.githubusercontent.com/labordynamicsinstitute/ssc-mirror}.
    Use this to point at your own clone of the mirror, which must use the
    same layout ({it:url}{cmd:/}{it:ref}{cmd:/fmwww.bc.edu/repec/bocode/}).
